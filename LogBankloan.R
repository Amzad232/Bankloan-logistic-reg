...
data_new=read.csv("C:/Users/shubhamv/Downloads/bankloan.csv")
#View(data_new)
str(data_new)
summary(data_new)
...
table(train_data_balanced$default,predicted_data_balanced>=0.5)
...
plot(roc_data_data_balance_train,colorize=T)
...
plot(roc_data_data_balance_test,colorize=T)
